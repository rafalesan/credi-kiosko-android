...
import com.rafalesan.credikiosko.presentation.databinding.HolderHomeOptionItemBinding

class HomeOptionsAdapter(private val onOptionSelected: (HomeOption) -> Unit) : ListAdapter<HomeOption, HomeOptionsAdapter.HomeOptionViewHolder>(HomeOptionDiffCallback) {
